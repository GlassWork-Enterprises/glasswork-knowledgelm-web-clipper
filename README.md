# KnowledgeLM Web Clipper

Chrome/Edge extension for capturing the current page into the GlassWork desktop app.
...
4. Choose `GlassWork/extensions/knowledgelm-web-clipper`.
